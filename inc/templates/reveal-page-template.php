...
[stallman.org](https://stallman.org)
	...
	<script src="<?php echo REVAL_JS; ?>/reveal-js/lib/js/head.min.js"></script>
	<script src="<?php echo REVAL_JS; ?>/reveal-js/js/reveal.js"></script>
	...
	<script>
	  ...
	  Reveal.initialize({
		...
		dependencies: [
		  { src: '<?php echo REVAL_JS; ?>/reveal-js/lib/js/classList.js', condition: function() { return !document.body.classList; } },
		  { src: '<?php echo REVAL_JS; ?>/reveal-js/plugin/markdown/marked.js', condition: function() { return !!document.querySelector( '[data-markdown]' ); } },
		  { src: '<?php echo REVAL_JS; ?>/reveal-js/plugin/markdown/markdown.js', condition: function() { return !!document.querySelector( '[data-markdown]' ); } },
		  { src: '<?php echo REVAL_JS; ?>/reveal-js/plugin/highlight/highlight.js', async: true, callback: function() { hljs.initHighlightingOnLoad(); } },
		  { src: '<?php echo REVAL_JS; ?>/reveal-js/plugin/zoom-js/zoom.js', async: true },
		  { src: '<?php echo REVAL_JS; ?>/reveal-js/plugin/notes/notes.js', async: true }
		]
	  });
